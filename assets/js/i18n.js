...
(function () {
  ...
  var FR = {
    ...
    "hero.title": "Ingénieur financier, je conçois des <em>outils d’IA</em> pour la gestion d’actifs.",
    "hero.lead": "Trois ans en gestion d’actifs, aujourd’hui consacrés à transformer données financières et documents réglementaires en décisions et en contenus clients — avec les contrôles qu’exige la finance : chiffres traçables, relecture humaine et maîtrise des coûts.",
    "hero.cta1": "Découvrir les projets",
    "hero.cta2": "Ouvrir l’app en ligne",
    "stat.years.l": "Années en gestion d’actifs",
    ...
    "about.kicker": "Profil",
    "about.title": "Du reporting à l’IA en production",
    "about.p1": "J’ai passé trois ans en gestion d’actifs sur des portefeuilles multi-actifs, l’analyse de performance et de risque, le reporting client et la documentation des fonds. J’ai déjà déployé en interne des prototypes basés sur Claude, avec des interfaces Power Apps et des automatisations n8n.",
    "about.p2": "Je recherche des postes à l’intersection de la finance et de l’IA : IA appliquée, outillage quantitatif ou produits d’IA pour les sociétés de gestion.",
    "about.k1": "Domaine",
    "about.v1": "Portefeuilles multi-actifs, performance et risque, reporting client, documentation PRIIPs / UCITS",
    "about.k2": "IA en production",
    "about.v2": "Prototypes sur l’API Claude, interfaces Power Apps, automatisations n8n",
    "about.k3": "Recherche",
    "about.v3": "IA appliquée · outillage quant · produit IA pour la gestion d’actifs",
    "about.k4": "Langues",
